...
Una vez cargado los paquetes a utilizar, usaremos la base de datos **CASEN* que fue procesada en el práctico anterior.

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)

load(file = "../06-class/06-clase/output/data/datos_proc.RData")
```
...
sjt.xtab(datos_proc$sexo, datos_proc$ife,  title = "Tabla de frecuencias",
         show.col.prc=TRUE,
         show.summary=FALSE)
```
