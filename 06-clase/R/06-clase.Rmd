...
También podemos editar un poco más este gráfico con argumentos como coord.flip, sort.frq, expand.rid, vjust, hjust 
...
También podemos graficar escalas likert, en esta ocasión CASEN no tiene variables con más categorías de respuesta para generar una escala likert es *estricto rigor*, por lo que utilizaremos las nuevas variables de la base procesada, para ello usaremos la función `plot_likert`
...
¡Ojo con los argumentos de esta función! Tiene muchas opciones, incluyendo a las *categorías neutras*
