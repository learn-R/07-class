...
```{r librerias, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
load(file = "../06-clase/output/datos_proc.RData")
```
...
```{r names, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
names(datos_proc)
```

Mientras que la función ```head``` nos entrega el nombre y las primeras filas que la componen.

```{r head, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
head(datos_proc)
```
...
```{r ejemplo mean, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
...
```{r casen mean, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen mean trim, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r ejemplo median, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
median(datos$variable, na.rm =TRUE)
```

```{r casen median, echo=TRUE, message=TRUE, warning=FALSE, results='markup'}
...
```{r ejemplo min y max, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
min(datos$variable)
max(datos$variable)

```

```{r casen min y max, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen quantile, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r ejemplo quantile, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
quantile(datos$variable, 0.25)
```

```{r casen quantile esp, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
quantile(datos_proc$ingreso_percapita, 0.25)
```

o un conjunto de valores, para eso usamos ```c()```

```{r casen quantile esp conj, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen summary, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen table, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen prop.table, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen prop.table*100, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen frq error, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r ejemplo etiquetas, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
datos_proc <- sjlabelled::remove_all_labels(datos_proc)
```

Ahora sí podremos conocer la tabla de frecuencias

```{r casen frq, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen range, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen var, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen sd, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen descr, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r ejemplo save, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
save_plot(
...
save_plot("../06-clase/output/tab.png", fig = a)
```
...
```{r casen filter, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen densidad, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
plot_frq(datos_proc, ingreso_percapita,
...
```{r casen lineas, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen scatter lineas, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen tab cruz, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen tab cruz encoding, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
...
```{r casen selec, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
cor <- datos_proc %>%  dplyr::select (horas_mens, ingreso_percapita)
```

Luego tendremos una tabla como esta

```{r casen corr, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
tab_corr(cor,
         triangle = "lower",   
...
```{r casen anova, echo=TRUE, message=FALSE, warning=FALSE, results='markup'}
