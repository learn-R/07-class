...
datos_proc <- readRDS(url("https://github.com/learn-R/www-learn-R-udp/raw/main/content/example/output/data/datos_proc.rds"))
```
...
Una vez conocidas las variables que incluye nuestros datos procesados, ¿cómo podemos realizar un análisis descriptivo de nuestros reportes?
